...
<body class="app sidebar-mini">
    ...
    <li><a class="app-menu__item active" href="<?php echo site_url('Panitia/hasilPertandingan'); ?>"><i class="app-menu__icon fa fa-table"></i><span class="app-menu__label">Hasil Pertandingan</span></a></li>
	...
	<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-table"></i> Hasil Pertandingan</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class=""></i></li>
          <li class="breadcrumb-item"><a href="#">Hasil Pertandingan</a></li>
        </ul>
      </div>

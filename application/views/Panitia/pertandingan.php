      ...
      <ul class="app-menu">
        ...
        <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-futbol"></i><span class="app-menu__label">Pertandingan</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item active" href="<?php echo site_url('Panitia/pertandingan'); ?>"><i class=""></i> Pilih Tim</a></li>
			  ...
			  <div class="col-lg-12">
				...
				<div class="bs-component">
				  <ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#kota">Pilih Kota</a></li>
					<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tim">Pilih Tim</a></li>
				  </ul>
				  <div class="tab-content" id="myTabContent">
					<div class="tab-pane fade active show" id="kota">
						<div class="form-group">
						  <label for="exampleSelect1"><br><b>Pilih Kota :</b></label>
						...
						<div class="tile-title-w-btn">
						  <div class="form-group">
							<label for="exampleSelect1"><b>Pilih Tim :</b></label>
						...
						<div data-toggle="tab" href="#tim">
						  <button class="btn btn-primary fa fa-arrow-right" type="button">&nbsp;&nbsp;&nbsp;&nbsp;Pilih Tim</button>
						</div>
					</div>
					<div class="tab-pane fade" id="tim">
						...
						<div>
							<h4 style="text-align:center;">BOGOR</h4>
						</div>
						...
						<a href="panitia-mulai-pertandingan.html">
						  <button class="btn btn-primary" type="button">Mulai Pertandingan</button>
						</a>
					</div>
				  </div>
				</div>

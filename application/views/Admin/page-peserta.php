...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a class="app-menu__item active" href="<?php echo site_url('Admin/peserta')?>"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Peserta</span></a></li>
	...
	<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-users"></i> Peserta</h1>
        </div>
		...
		<div class="col-md-12">
		  <div class="tile">
			<div class="tile-title-w-btn">
              ...
              <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Peserta</button>
            </div>
            <hr>
            <div class="col-md-12">
	          <div class="tile">
	          	<form role="form" action="<?php echo site_url('Admin/peserta'); ?>" method="post">
	              ...
	              <table class="table">
	                ...
	                <?php
					  ...
					  if ($nilai->result() == null) {
					    echo "<tr><td colspan='9'><center>Tidak ada peserta</center></td></tr>";
					  }else{
					    foreach ($nilai->result() as $pernilai) {
					      echo "<tr>
					      			<td>".$pernilai->namaPendaftar."</td>
					                <td>".$pernilai->email."</td>
					                <td>".$pernilai->notelpPeserta."</td>
					                <td>".$pernilai->noIdentitas."</td>
					                <td>".$pernilai->posisi."</td>
					                <td>".$pernilai->asalSekolah."</td>
					                <td>".$pernilai->ikutSerta."</td>
					                <td>".$pernilai->namaTim."</td>
					                <td>";?>
					                  <a href="<?php echo site_url('Admin/aksiUpdatePeserta/'.$pernilai->idPeserta) ?>" class="btn btn-primary" onClick="return confirm('Yakin ingin menghapus anggota ini?')"><i class="fa fa-edit"></i></a>
					                  <a href="<?php echo site_url('Admin/aksiDeletePeserta/'.$pernilai->idPeserta) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus anggota ini?')"><i class="fa fa-trash"></i></a>
					                  <?php echo "
					                </td>
					            </tr>";
					    }
   ...
   <div class="modal-dialog">
     ...
     <div class="modal-content">
       ...
       <div class="modal-body">
          <form action="<?php echo site_url('Admin/aksiAddPanitia') ?>" method="post">
            <div class="form-row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Nama Pendaftar</label>
                <input type="text" name="namaPendaftar" class="form-control" placeholder="Nama.." required/>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-12">
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="number" name="notelpUser" class="form-control" placeholder="No. Telpon.." required/>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">No. Identitas (KTP/SIM/Kartu Siswa)</label>
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="text" name="namaTim" class="form-control" placeholder="Nama Tim.." required/>
              </div>
            </div>
            <div class="form-row">

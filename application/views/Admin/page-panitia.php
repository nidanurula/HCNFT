...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a class="app-menu__item active" href="<?php echo site_url('Admin/panitia')?>"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Panitia</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user"></i> Panitia</h1>
        </div>
		...
		<div class="col-md-12">
		  <div class="tile">
			<div class="tile-title-w-btn">
              ...
              <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Panitia</button>
            </div>
            <hr>
            <div class="col-md-12">
	          <div class="tile">
	          	<form role="form" action="<?php echo site_url('Admin/panitia'); ?>" method="post">
					  ...
					  if ($nilai->result() == null) {
					    ...
					    foreach ($nilai->result() as $pernilai) {
					      echo "<tr>
					                ...
					                <td>";?>
					                  <a href="<?php echo site_url('Admin/aksiUpdatePanitia/'.$pernilai->username) ?>" class="btn btn-primary"  ><i class="fa fa-edit"></i></a>
          ...
          <form action="<?php echo site_url('Admin/aksiAddPanitia') ?>" method="post">
            ...
            <div class="form-row">
              <div class="form-group col-md-12">
                ...
                <input type="date" name="tgllahirUser" class="form-control"/>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-12">
                <label for="exampleInputEmail1">Alamat</label>
                <input type="text" name="alamatUser" class="form-control" placeholder="Alamat.."/>
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-12">

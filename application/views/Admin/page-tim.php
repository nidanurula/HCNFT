...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-cubes"></i> Tim</h1>
        </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              ...
              <button type="button" name="button" data-toggle="modal" data-target="#myModal" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Tim</button>
            </div>
            <hr>

            <div class="col-md-12">
            <div class="tile">
              <form role="form" action="<?php echo site_url('Admin/tim'); ?>" method="post">
          ...
          <?php foreach ($nilai->result() as $value) {
            ...
            if ($nilai->result() == null) {
              echo "<tr><td colspan='6'><center>Tidak ada tim</center></td></tr>";
            }else{
              foreach ($nilai->result() as $pernilai) {
                echo "<tr>
                      <td>".$pernilai->namaTim."</td>
                          <td>".$pernilai->idPeserta."</td>
                          <td>".$pernilai->logo."</td>
                          <td>";?>
                            <a href="<?php echo site_url('Admin/detailTim/'.$pernilai->idTim) ?>" class="btn btn-primary">Lihat Detail</a>
                            <?php echo "
                          </td>
                      </tr>";
              }
